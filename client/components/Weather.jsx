...
const Weather = () => {
  ...
  <div key={index} >
    ...
    {/* <p className="weather-icon"> Current Conditions : {getWeatherIcon(weatherData.weathercode[index])}</p> */}
    {/* <div className="weather-icon"><FontAwesomeIcon icon={faGlobe} size='2x' beat /> : {getWeatherIcon(weatherData.weathercode[index])}</div> */}
    ...
    {console.log(getWeatherIcon(weatherData.weathercode[index].value))}
  </div>
      ))}
    </div>
  );
